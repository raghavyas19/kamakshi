...
const Calendar: React.FC = () => {
  ...
  return (
    <div className="relative">
      ...
      {/* Controls */}
  <div className="py-8 bg-gradient-to-b from-treegreen-50 via-treepurple-50 to-treegreen-100 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800">
  ...
  <div className="py-16 bg-gradient-to-b from-treegreen-50 via-treepurple-50 to-treegreen-100 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800">
      ...
      {/* Past Events */}
      {pastEvents.length > 0 && (
  <div className="py-16 bg-gradient-to-r from-treepurple-100 via-treegreen-100 to-treegreen-200 dark:from-gray-800 dark:via-gray-800 dark:to-gray-700">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
