...
const Members: React.FC = () => {
  ...
  return (
    <div className="relative">
      ...
      {/* Member of the Month */}
  <div className="py-16 bg-gradient-to-b from-treepurple-100 via-treegreen-50 to-treegreen-100 dark:from-gray-800 dark:to-gray-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <Card className="max-w-4xl mx-auto p-8 shadow-xl border border-treegreen-200 bg-white/90 backdrop-blur-md">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {coreTeam.map((member, index) => (
              ...
              >
                <Card className="text-center p-6 h-full hover:shadow-2xl transition-all duration-300 border border-treepurple-100 bg-white/80">
                  <img
                    src={member.image}
                    alt={member.name}
  ...
  <div className="py-16 bg-gradient-to-b from-treegreen-100 via-treepurple-50 to-treegreen-50 dark:from-gray-800 dark:via-gray-900 dark:to-gray-800">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {activeMembers.map((member, index) => (
              <motion.div
                ...
                transition={{ duration: 0.6, delay: index * 0.1 }}
              >
                <Card className="p-6 text-center border border-treegreen-100 bg-white/80">
                  <img
                    src={member.image}
                    alt={member.name}
      ...
      {/* Stats */}
  <div className="py-16 bg-gradient-to-r from-treepurple-500 to-treegreen-400">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
