...
const Home: React.FC = () => {
  ...
  return (
  <div className="min-h-screen bg-gradient-to-b from-pink-50 via-purple-50 to-blue-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800">
      {/* Hero Section */}
  <div className="relative bg-gradient-to-br from-treepurple-500 via-treegreen-400 to-treegreen-200 py-20">
